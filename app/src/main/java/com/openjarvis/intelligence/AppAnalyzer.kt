...
class AppAnalyzer(private val context: Context) {
    ...
    suspend fun onAppInstalled(packageName: String) = withContext(Dispatchers.IO) {
        ...
        if (!info.enabled || packageName == context.packageName) {
            return@withContext
        }
        ...
        val entity = AppIntelligenceEntity(
            ...
            trustScore = if (knownAI != null) 0.5f else 0.6f,
            lastAnalyzed = System.currentTimeMillis(),
    ...
    suspend fun updateTrustScore(
        ...
        val current = dao.getByPackage(packageName)
            ?: return@withContext
    ...
    suspend fun getAllSortedByTrust(): List<AppIntelligenceEntity> =
        dao.getAllSortedByTrust()

    private fun categorizeApp(
        appName: String,
        packageName: String
    ): String {
    ...
    private fun detectCapabilities(
         ...
         *
         * Added Copilot and several common AI applications.
         *
         * This is important because AIAppMeta may know about
         * an application, but capability detection also needs
         * to classify the installed application correctly.
         */
        val isAIApp =
            pkg.contains("ai.") ||
            name.contains("gpt") ||
            ...
            name.contains("character") ||
            pkg.contains("openai") ||
            pkg.contains("anthropic") ||
            pkg.contains("googleai")
